...
RUN curl 'https://mathgen.stats.ox.ac.uk/impute/impute_v2.3.2_x86_64_static.tgz'> impute_v2.3.2_x86_64_static.tgz && \ 
  tar zxvf impute_v2.3.2_x86_64_static.tgz> impute2 && rm impute_v2.3.2_x86_64_static.tgz && mv impute2 /usr/local/bin
