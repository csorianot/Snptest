...
RUN curl -L 'http://www.well.ox.ac.uk/~gav/resources/qctool_v2.0-rc9-Ubuntu16.04-x86_64.tgz' && tar zxvf qctool_v2.0-rc9-Ubuntu16.04-x86_64.tgz  && mv qctool_v2.0-rc9-Ubuntu16.04-x86_64/* /usr/local/bin/
