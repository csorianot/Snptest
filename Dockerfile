...
RUN curl 'https://mathgen.stats.ox.ac.uk/genetics_software/shapeit/shapeit.v2.r904.glibcv2.17.linux.tar.gz'> shapeit.v2.r904.glibcv2.17.linux.tar.gz && \
 tar zxvf shapeit.v2.r904.glibcv2.17.linux.tar.gz && rm shapeit.v2.r904.glibcv2.17.linux.tar.gz && rm shapeit.v2.904.3.10.0-693.11.6.el7.x86_64/example/ && mv shapeit.v2.904.3.10.0-693.11.6.el7.x86_64/* /usr/local/bin/
