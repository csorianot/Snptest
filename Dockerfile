...
RUN curl -LO 'http://s3.amazonaws.com/plink1-assets/plink_linux_x86_64_20190304.zip' && unzip plink_linux_x86_64_20190304.zip && rm plink_linux_x86_64.zip && mv plink /usr/local/bin/
