...
RUN curl 'https://www.well.ox.ac.uk/~cfreeman/software/gwas/gtool_v0.7.5_x86_64_dynamic.tgz' && \ 
 tar zxvf gtool_v0.7.5_x86_64_dynamic.tgz && rm gtool_v0.7.5_x86_64_dynamic.tgz && mv gtool /usr/local/bin
...
RUN curl -LO 'https://www.well.ox.ac.uk/~gav/resources/qctool_v2.0.1-Ubuntu14.04-x86_64.tgz' && tar zxvf qctool_v2.0.1-Ubuntu14.04-x86_64.tgz  && mv qctool_v2.0.1-Ubuntu14.04-x86_64/* /usr/local/bin/ && chmod 777 /usr/local/bin/*
