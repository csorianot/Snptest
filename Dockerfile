...
RUN curl 'https://bitbucket.org/gavinband/qctool/get/1215abdf6740.zip' && unzip gavinband-qctool-1215abdf6740.zip && rm gavinband-qctool-1215abdf6740.zip && mv gavinband-qctool-1215abdf6740/doc gavinband-qctool-1215abdf6740/doc2 && mv gavinband-qctool-1215abdf6740/* /usr/local/bin/ &&  /usr/local/bin/waf-1.5.18 configure && /usr/local/bin/waf-1.5.18
