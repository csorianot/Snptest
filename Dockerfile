...
RUN curl 'https://mathgen.stats.ox.ac.uk/impute/impute_v2.3.2_x86_64_static.tgz'> impute.tgz && \ tar -zxvf impute.tgz
     && rm impute.tgz && mv impute /usr/local/bin
...
RUN curl 'http://www.well.ox.ac.uk/~cfreeman/software/gwas/gtool_v0.7.5_x86_64.tgz'> gtool.tgz && \ tar -zxvf gtool.tgz
     && rm gtool.tgz && mv gtool /usr/local/bin
