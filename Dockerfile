...
RUN curl http://www.cog-genomics.org/static/bin/plink180528/plink_linux_x86_64.zip && unzip plink_linux_x86_64.zip && rm plink_linux_x86_64.zip && mv plink_linux_x86_64 /usr/local/bin/
