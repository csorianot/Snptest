...
RUN curl 'http://s3.amazonaws.com/plink1-assets/plink_linux_x86_64_20181202.zip' && unzip plink_linux_x86_64_20181202.zip && link_linux_x86_64_20181202.zip && mv plink /usr/local/bin/
